...
export const HeroButtons = ({ loaded, isMobile }: HeroButtonsProps) => {
  ...
  return (
    <div className={`flex flex-col md:flex-row justify-center items-center gap-2 md:gap-3 transition-all delay-200 duration-700 px-3 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      <a 
