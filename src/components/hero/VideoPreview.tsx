    ...
    >
      <div className="relative w-full rounded-xl overflow-hidden shadow-glow border border-white/10 aspect-video transform hover:scale-[1.01] transition-all duration-300">
        ...
        <iframe 
          width="100%" 
          height="100%" 
          src="https://www.youtube.com/embed/Zdthelofv_E?rel=0&autoplay=1&playsinline=1&enablejsapi=1&modestbranding=1&origin=https://www.aiwebtools.ai&vq=hd1080&playlist=Zdthelofv_E&controls=1" 
